    ...
    def start_temperature_check(self, target_temp):
        if ENABLE_HARDWARE:
            ...
            while True:
                ...
                # 🔥 Emergency shutdown if temp > 450°C
                if temperature >= 450:
                    print("‼️ EMERGENCY: Heater turned OFF due to temperature > 450°C during preheat")
...
#Code for the python-sensorsdef check_person_weight(self):
    ...
    def activate_safe_mode(self):
        ...
        for frame in [self.heat_frame, self.speed_frame, self.time_frame, self.button_panel_frame]:
            if frame:
                frame.destroy()
